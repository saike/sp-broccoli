...
class ViewPopupBadge extends ViewBase {
    ...
    _prepareTplData () {
        ...
        let entries = [], entriesById = {},
            top=20, leftPos=[23,127,232,127],
            leftPosIndex = 3, received = 0;

        if (this._tplData.list) {
            let li=this._tplData.list.length,
                item, d = {};
            ...
            let railways = [],
                w = {}, rwSize = [[16,176, 'way1'],[128,17, 'way2'],[5,17, 'way3'],[93,175, 'way4']], // [topShift,left]
